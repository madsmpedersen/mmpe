...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionSayHello = QtWidgets.QAction(MainWindow)
        self.actionSayHello.setObjectName("actionSayHello")
        self.menuFile.addAction(self.actionSayHello)
        self.menubar.addAction(self.menuFile.menuAction())

        self.retranslateUi(MainWindow)
        self.pushButton.clicked.connect(self.actionSayHello.trigger)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSayHello.setText(_translate("MainWindow", "SayHello"))
        self.actionSayHello.setToolTip(_translate("MainWindow", "Prints \"Hello\""))
        self.actionSayHello.setShortcut(_translate("MainWindow", "Ctrl+S"))
